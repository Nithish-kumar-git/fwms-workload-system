# 🧊 FROZEN SYSTEM BLUEPRINT (FSB) v1.1
...
- status ('SELECTED', 'OVERRIDDEN', 'CANCELLED')
- selected_at
...
### 3.2 staff_slot_number (EXACT DEFINITION)
...
### 3.3 Quota Enforcement (RACE-SAFE)
...
### 3.4 SELECT SUBJECT — TRANSACTION FLOW (EXACT)
```sql
...
### 3.5 CHANGE SUBJECT — DEADLOCK-SAFE RULES
