...
-- tch_norm: AsstProf=40, AssocProf=36, Professor=30, HOD=24, Part-time=reduced
-- ============================================================================
...
VALUES ('mct44@faculty.local', 'Dr. S. Gokila', 'MCT44', 'HOD', 'SHIFT1', 24, 38,
...
VALUES ('mct50@faculty.local', 'Dr. S. Sudha', 'MCT50', 'Professor', 'SHIFT1', 30, 38,
    true, 'MCA', 'A', 'IV', 1)
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO staff (email, name, emp_code, designation, shift, tch_norm, total_workload_norm,
    is_class_teacher)
VALUES ('mct68@faculty.local', 'Dr. Ayyanathan A', 'MCT68', 'Professor', 'SHIFT1', 30, 38,
    false)
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO staff (email, name, emp_code, designation, shift, tch_norm, total_workload_norm,
    is_class_teacher, ct_program, ct_section, ct_semester, ct_shift)
VALUES ('mct61@faculty.local', 'Dr. H J Shanthi', 'MCT61', 'Associate Professor', 'SHIFT1', 36, 38,
    true, 'BCA', 'A', 'VI', 1)
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO staff (email, name, emp_code, designation, shift, tch_norm, total_workload_norm,
    is_class_teacher, ct_program, ct_section, ct_semester, ct_shift)
VALUES ('mct69@faculty.local', 'Dr. Priya M', 'MCT69', 'Associate Professor', 'SHIFT1+SHIFT2', 36, 38,
    true, 'BCA', 'A', 'VI', 2)
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO staff (email, name, emp_code, designation, shift, tch_norm, total_workload_norm,
    is_class_teacher)
VALUES ('cns02@faculty.local', 'Mr. N. Sivakumar', 'CNS02', 'Assistant Professor', 'SHIFT1', 40, 40,
    false)
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO staff (email, name, emp_code, designation, shift, tch_norm, total_workload_norm,
    is_class_teacher, ct_program, ct_section, ct_semester, ct_shift)
VALUES ('mct48@faculty.local', 'Dr. Sathish Kumar M', 'MCT48', 'Assistant Professor', 'SHIFT1', 40, 40,
    true, 'MCA', 'B', 'II', 1)
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO staff (email, name, emp_code, designation, shift, tch_norm, total_workload_norm,
    is_class_teacher, ct_program, ct_section, ct_semester, ct_shift)
VALUES ('mct49@faculty.local', 'Dr. Angelina Benita D', 'MCT49', 'Assistant Professor', 'SHIFT1', 40, 40,
    true, 'BCA', 'A', 'II', 1)
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO staff (email, name, emp_code, designation, shift, tch_norm, total_workload_norm,
    is_class_teacher)
VALUES ('mct54@faculty.local', 'Mrs. Vinitha Sushila Devi S', 'MCT54', 'Assistant Professor', 'SHIFT2', 40, 40,
    false)
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO staff (email, name, emp_code, designation, shift, tch_norm, total_workload_norm,
    is_class_teacher, ct_program, ct_section, ct_semester, ct_shift)
VALUES ('mct65@faculty.local', 'Dr. Lakshmanan S', 'MCT65', 'Assistant Professor', 'SHIFT1', 40, 40,
    true, 'BCA', 'B', 'VI', 1)
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO staff (email, name, emp_code, designation, shift, tch_norm, total_workload_norm,
    is_class_teacher, ct_program, ct_section, ct_semester, ct_shift)
VALUES ('mct39@faculty.local', 'Dr. Sherin Eliyas', 'MCT39', 'Assistant Professor', 'SHIFT1', 40, 40,
    true, 'MCA', 'B', 'IV', 1)
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO staff (email, name, emp_code, designation, shift, tch_norm, total_workload_norm,
    is_class_teacher, ct_program, ct_section, ct_semester, ct_shift)
VALUES ('mct60@faculty.local', 'Dr. Nathiya R', 'MCT60', 'Assistant Professor', 'SHIFT1', 40, 40,
    true, 'BCA', 'A', 'IV', 1)
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO staff (email, name, emp_code, designation, shift, tch_norm, total_workload_norm,
    is_class_teacher, ct_program, ct_section, ct_semester, ct_shift)
VALUES ('mct53@faculty.local', 'Mrs. Sophia Janit R', 'MCT53', 'Assistant Professor', 'SHIFT1', 40, 40,
    true, 'BCA', 'C', 'IV', 1)
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO staff (email, name, emp_code, designation, shift, tch_norm, total_workload_norm,
    is_class_teacher, ct_program, ct_section, ct_semester, ct_shift)
VALUES ('mct58@faculty.local', 'Mrs. Kalpana K', 'MCT58', 'Assistant Professor', 'SHIFT2', 40, 40,
    true, 'BCA', 'E', 'II', 2)
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO staff (email, name, emp_code, designation, shift, tch_norm, total_workload_norm,
    is_class_teacher, ct_program, ct_section, ct_semester, ct_shift)
VALUES ('mct63@faculty.local', 'Mrs. Karunambikai M', 'MCT63', 'Assistant Professor', 'SHIFT1', 40, 40,
    true, 'BCA', 'B', 'IV', 1)
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO staff (email, name, emp_code, designation, shift, tch_norm, total_workload_norm,
    is_class_teacher)
VALUES ('mct59@faculty.local', 'Dr. Vanitha Jaitly', 'MCT59', 'Assistant Professor', 'SHIFT1', 40, 40,
    false)
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO staff (email, name, emp_code, designation, shift, tch_norm, total_workload_norm,
    is_class_teacher)
VALUES ('mct73@faculty.local', 'Mrs. Mary Reni', 'MCT73', 'Assistant Professor', 'SHIFT1', 40, 40,
    false)
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO staff (email, name, emp_code, designation, shift, tch_norm, total_workload_norm,
    is_class_teacher, ct_program, ct_section, ct_semester, ct_shift)
VALUES ('lat74@faculty.local', 'Dr. C Bagyalakshmi', 'LAT74', 'Assistant Professor', 'SHIFT2', 40, 40,
    true, 'BCA', 'B', 'VI', 2)
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO staff (email, name, emp_code, designation, shift, tch_norm, total_workload_norm,
    is_class_teacher, ct_program, ct_section, ct_semester, ct_shift)
VALUES ('mct71@faculty.local', 'Mr. Prabu', 'MCT71', 'Assistant Professor', 'SHIFT2', 40, 40,
    true, 'BCA', 'B', 'IV', 2)
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO staff (email, name, emp_code, designation, shift, tch_norm, total_workload_norm,
    is_class_teacher, ct_program, ct_section, ct_semester, ct_shift)
VALUES ('mct70@faculty.local', 'Dr. C Bala Kamatchi', 'MCT70', 'Assistant Professor', 'SHIFT1+SHIFT2', 40, 40,
    true, 'BCA', 'A', 'IV', 2)
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO staff (email, name, emp_code, designation, shift, tch_norm, total_workload_norm,
    is_class_teacher, ct_program, ct_section, ct_semester, ct_shift)
VALUES ('mct78@faculty.local', 'Dr. Sheeja Sudheer', 'MCT78', 'Associate Professor', 'SHIFT1+SHIFT2', 36, 38,
    true, 'BCA', 'D', 'II', 1)
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO staff (email, name, emp_code, designation, shift, tch_norm, total_workload_norm,
    is_class_teacher, ct_program, ct_section, ct_semester, ct_shift)
VALUES ('mct77@faculty.local', 'Dr. Jaya Sundaram', 'MCT77', 'Assistant Professor', 'SHIFT1+SHIFT2', 40, 40,
    true, 'BCA', 'B', 'II', 1)
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO staff (email, name, emp_code, designation, shift, tch_norm, total_workload_norm,
    is_class_teacher, ct_program, ct_section, ct_semester, ct_shift)
VALUES ('mct76@faculty.local', 'Ms. Karthika', 'MCT76', 'Assistant Professor', 'SHIFT1+SHIFT2', 40, 40,
    true, 'BCA', 'C', 'II', 1)
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO staff (email, name, emp_code, designation, shift, tch_norm, total_workload_norm,
    is_class_teacher)
VALUES ('mct79@faculty.local', 'Ms. Divya Prabha B', 'MCT79', 'Assistant Professor', 'SHIFT1', 40, 40,
    false)
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO staff (email, name, emp_code, designation, shift, tch_norm, total_workload_norm,
    is_class_teacher)
VALUES ('mct75@faculty.local', 'Mr. Shyam Praveen B', 'MCT75', 'Assistant Professor', 'SHIFT2', 40, 40,
    false)
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO staff (email, name, emp_code, designation, shift, tch_norm, total_workload_norm,
    is_class_teacher)
VALUES ('mct01@faculty.local', 'Dr. Anitha S Pillai', 'MCT01', 'Professor', 'SHIFT1', 15, 24,
    false)
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO staff (email, name, emp_code, designation, shift, tch_norm, total_workload_norm,
    is_class_teacher)
VALUES ('mct42@faculty.local', 'Mr. Ramanayagam', 'MCT42', 'Associate Professor', 'SHIFT1', 18, 24,
    false)
ON CONFLICT (email) DO NOTHING;
...
INSERT INTO staff (email, name, emp_code, designation, shift, tch_norm, total_workload_norm,
    is_class_teacher)
VALUES ('mcp04@faculty.local', 'Mr. Senthil', 'MCP04', 'Assistant Professor', 'SHIFT2', 20, 24,
    false)
ON CONFLICT (email) DO NOTHING;
